...
router.get('/journey', authenticate, followupController.getRecoveryJourney);
router.post('/simulate-review', authenticate, followupController.simulateOfficerReview);
