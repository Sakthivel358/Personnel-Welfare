...
async def health_check():
    ...
    try:
        ...
        details = {
            ...
            "model_version": prep.get("model_version", "v1.4.0"),
    ...
    return {
        ...
        "service": "SIH26186-FastAPI-ML-Engine",
...
async def get_model_info():
    ...
    try:
        ...
        return {
            ...
            "disclaimer": "DEMO / SYNTHETIC DATA — Decision-support model for SIH26186 prototype."
        }
    except Exception as e:
